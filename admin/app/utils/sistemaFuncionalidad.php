...
$f3->route('PUT  /core/fileExplorer/delFolder',                       'sistemaFuncionalidad->FileExplorer_delFolder');    //Eliminacion de carpetas
$f3->route('PUT  /core/fileExplorer/delFile',                         'sistemaFuncionalidad->FileExplorer_delFile');      //Eliminacion de archivos
