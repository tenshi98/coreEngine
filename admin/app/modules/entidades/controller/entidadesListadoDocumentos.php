...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class entidadesListadoDocumentos extends ControllerBase {
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idDocumentos,idEntidad,Nombre,Observacion,FVencimiento',
            'table'   => 'entidades_listado_documentos',
            'join'    => '',
            'where'   => 'idDocumentos = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idEntidad,Nombre,Observacion,FVencimiento',
            'required'  => 'idEntidad,Nombre',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'entidades_listado_documentos',
            'Post'      => $_POST,
