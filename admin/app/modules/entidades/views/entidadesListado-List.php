        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                            ...
                            <?php if($data['UserAccess']['LevelAccess']>=3){ ?>
                                <div class="btn-group" role="group">
                                    <a class="btn btn-primary" href="<?php echo $BASE.'/'.$data['UserAccess']['RouteAccess'].'/exportar/'; ?>"><i class="bi bi-file-earmark-excel"></i> Exportar Datos</a>
                    ...
                    <?php require_once('entidadesListado-formSearch.php'); ?>
                    <div class="clearfix"></div>
                    <div class="table-responsive" id="listTableData">
                        <?php require_once('entidadesListado-UpdateList.php'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php require_once('entidadesListado-formNew.php'); ?>
