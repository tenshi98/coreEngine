...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class pagosSimple extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'pagosSimple';
    ...
    public function listAll($f3){
        ...
        $f3->data = [
            /*=========== Datos de la Pagina ===========*/
            'PageTitle'       => 'Informe Pagos Simplificados',
            'PageDescription' => 'Informe Pagos Simplificados.',
    ...
    public function UpdateList($f3){
        ...
        if(is_array($arrList)){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'TableTitle'      => 'Informe Pagos Simplificados',
                /*===========  Datos del usuario ===========*/
                'UserData'      => $UserData,
                'UserAccess'    => $arrLevel[$this->controllerName],
                /*===========   Funcionalidad   ===========*/
    ...
    public function Insert(){
        ...
        /*******************************************************************/
        //variables
        $ndata_1 = isset($_POST['idFacturacion']) ? count($_POST['idFacturacion']) : 0;
        ...
        if($DataVal['Count']==0) {
            ...
            if(isset($ndata_1)&&$ndata_1!=0){
                ...
                for($j1 = 0; $j1 < $ndata_1; $j1++){
                    ...
                    //Se agrega respuesta
                    $PostPago = [
                        'idFacturacion'    => $_POST['idFacturacion'][$j1],
                        'MontoPagado'      => $_POST['MontoPagado'][$j1],
                    ...
                    /*******************************************************/
                    //Se instancia
                    $gestionDocumentosPagos = new gestionDocumentosPagos();
                    $gestionDocumentosPagos->insertPago($PostPago);
