...
<script>
    ...
    /******************************************/
    function whatsappSendInfo(Entidad, Fono, Documentos, Total) {
        Swal.fire({
            title: "Enviar Notificacion",
            text: "Esta a punto de enviar una notificacion a " + Entidad + ", ¿Desea continuar?",
            icon: "warning",
            ...
            if (result2.isConfirmed) {
                //Se genera URL
                let urlWhatsapp = "https://api.whatsapp.com/send/?phone="+Fono+"&text=Hola+"+Entidad+"!!!%0ATe+dejo+detalle+de+las+paltas+pendientes+de+pago:%0A"+Documentos+"%0ATotal+a+transferir+"+Total+".%0A%0A🥑🥑Muchas+gracias🥑🥑&type=phone_number&app_absent=0";
