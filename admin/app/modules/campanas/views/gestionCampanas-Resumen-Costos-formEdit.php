<form id="FormEditItem" name="FormEditItem" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        $x2 = (!empty($data['rowData']['Costos']) && $data['rowData']['Costos'] != 0)
            ? $data['Fnc_DataNumbers']->cantidadesDecimalesJustos($data['rowData']['Costos'])
            : '';

        //se dibujan los inputs
        $data['Fnc_FormInputs']->formInput(['FormType' => 1, 'Placeholder' => 'Item',    'Name' => 'Item',    'Id' => 'EditCosto_Item',    'Value' => $x1, 'Required' => 2]);
        $data['Fnc_FormInputs']->formInput(['FormType' => 6, 'Placeholder' => 'Costos',  'Name' => 'Costos',  'Id' => 'EditCosto_Costos',  'Value' => $x2, 'Required' => 2,'Icon' => 'bi bi-currency-dollar']);
...
<script>
    ...
    $("#FormEditItem").submit(function(e) {
        ...
        if(validatorResult.valid===false){
            ...
            //Ejecuto
            let Metodo      = 'POST';
            let Direccion   = '<?php echo $BASE.'/'.$data['UserAccess']['RouteAccess'].'/costos/update'; ?>';
