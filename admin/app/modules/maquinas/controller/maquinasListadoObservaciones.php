...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class maquinasListadoObservaciones extends ControllerBase {
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idObservaciones,idMaquina,Observacion,FechaCreacion',
            'table'   => 'maquinas_listado_observaciones',
            'join'    => '',
            'where'   => 'idObservaciones = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idMaquina,Observacion,FechaCreacion',
            'required'  => 'idMaquina,Observacion,FechaCreacion',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'maquinas_listado_observaciones',
            'Post'      => $_POST
