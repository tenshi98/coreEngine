                ...
                <div class="d-flex justify-content-center pt-3">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        ...
                        <form id="FormSearchData" name="FormSearchData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
                            ...
                            $data['Fnc_FormInputs']->formSelectFilter([ 'Placeholder' => 'Producto', 'Name' => 'idProducto', 'Id' => 'Search_idProducto',  'Value' => '','Required' => 1,'arrData' => $data['arrProductos'], 'BASE' => $BASE]);
...
<script>
    ...
    function listTableDataView(idProducto, idBodegas) {
        ...
        let URL       = '<?php echo $BASE.'/'.$data['UserAccess']['RouteAccess'].'/view/'; ?>'+idProducto+'/'+idBodegas;
        const Options = {
            showModal : '#viewModal',
            closeObject:'#PDloader',
        };
