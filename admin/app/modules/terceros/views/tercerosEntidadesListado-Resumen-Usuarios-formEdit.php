...
<form id="FormEditUsuarios" name="FormEditUsuarios" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
    ...
    <div class="modal-body">
        ...
        $data['Fnc_FormInputs']->formInput(['FormType' => 2,  'Placeholder' => 'Email',   'Name'  => 'email',   'Id'  => 'EditUsuarios_email',   'Value'  => ($data['rowData']['email'] ?? ''),   'Required'  => 2, 'Icon' => 'bx bx-mail-send']);
        $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'Nombre',  'Name'  => 'Nombre',  'Id'  => 'EditUsuarios_Nombre',  'Value'  => ($data['rowData']['Nombre'] ?? ''),  'Required'  => 2]);
        $data['Fnc_FormInputs']->formInput(['FormType' => 11, 'Placeholder' => 'Rut',     'Name'  => 'Rut',     'Id'  => 'EditUsuarios_Rut',     'Value'  => ($data['rowData']['Rut'] ?? ''),     'Required'  => 1, 'Icon' => 'bi bi-person-circle']);
        $data['Fnc_FormInputs']->formInput(['FormType' => 4,  'Placeholder' => 'Fono',    'Name'  => 'Fono',    'Id'  => 'EditUsuarios_Fono',    'Value'  => ($data['rowData']['Fono'] ?? ''),    'Required'  => 1, 'Icon' => 'bi bi-telephone-fill']);

        $data['Fnc_FormInputs']->formTittle(['Tipo' => 4,'Texto' => 'Configuración', 'Clase' => 'box-title text-color-red-dark']);
        $data['Fnc_FormInputs']->formSelectFilter([         'Placeholder' => 'Tipo de Usuario',  'Name' => 'idTipoUsuario', 'Id' => 'EditUsuarios_idTipoUsuario',  'Value' => ($data['rowData']['idTipoUsuario'] ?? ''), 'Required' => 2,'arrData' => $data['arrTipoUsuario'], 'BASE' => $BASE]);
