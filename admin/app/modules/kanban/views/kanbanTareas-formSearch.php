        ...
        <div class="container well">
            <div class="row">
                <div class="col align-self-center">
                    ...
                    $data['Fnc_FormInputs']->formSelect([                 'Placeholder' => 'Prioridad',     'Name' => 'idPrioridad',    'Id' => 'Search_idPrioridad',    'Value' => '', 'Required' => 1,'arrData' => $data['arrPrioridad']]);
                    $data['Fnc_FormInputs']->formInput(['FormType' => 8,  'Placeholder' => 'Fecha Termino', 'Name' => 'Fecha',          'Id' => 'Search_Fecha',          'Value' => '', 'Required' => 1,'Icon' => 'bi bi-calendar3']);
                    $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'Titulo',        'Name' => 'Titulo',         'Id' => 'Search_Titulo',         'Value' => '', 'Required' => 1]);
                    $data['Fnc_FormInputs']->formSelect([                 'Placeholder' => 'Estado Cierre', 'Name' => 'idEstadoCierre', 'Id' => 'Search_idEstadoCierre', 'Value' => '', 'Required' => 1,'arrData' => $data['arrEstadoCierre']]);
...
<script>
    ...
    $("#FormSearchData").submit(function(e) {
        ...
        const Options     = {
            UpdateDivFrom : 'listTableDataList',
            colapseDiv : 'true',
            refreshTables : 'true',
