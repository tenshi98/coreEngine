...
class kanbanTrabajos extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'kanbanTrabajos';
    ...
    public function listAll($f3){
        ...
        if($arrList['status'] && $arrEstado['status']){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Tareas Kanban',
                'PageDescription' => 'Tareas Kanban.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Listado Tareas Kanban',
                /*===========  Datos del usuario ===========*/
    ...
    public function GetID($f3, $params){
        ...
        //si no hay resultados
            ...
            //Busco errores de la consulta
            $result = $this->mergeResponses([$rowData,$arrEstado]);
            //Muestra los errores
            $this->showError(2, $f3, $result);
        }
    }
