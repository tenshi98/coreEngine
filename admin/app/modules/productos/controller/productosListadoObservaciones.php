...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class productosListadoObservaciones extends ControllerBase {
    ...
    public function New($f3, $params){
        ...
        if($rowData['status']){
            ...
            $this->showVista(2, $this->returnRutaVista(__DIR__, 'app').'/'.$this->controllerName.'-Resumen-Observaciones-formNew.php');
        /*******************************************************************/
    ...
    public function UpdateList($f3, $params){
        ...
        if($arrObservaciones['status']){
            ...
            /******************************************/
            //Se instancia la vista
            $this->showVista(2, $this->returnRutaVista(__DIR__, 'app').'/'.$this->controllerName.'-Resumen-Observaciones-UpdateList.php');
        /*******************************************************************/
        //si no hay resultados
        } else {
            //Busco errores de la consulta
    ...
    public function View($f3, $params){
        ...
        if($rowData['status']){
            ...
            /******************************************/
            //Se instancia la vista
            $this->showVista(2, $this->returnRutaVista(__DIR__, 'app').'/'.$this->controllerName.'-Resumen-Observaciones-View.php');
        /*******************************************************************/
        //si no hay resultados
        } else {
            //Busco errores de la consulta
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idObservaciones,idProducto,Observacion,FechaCreacion',
            'table'   => 'productos_listado_observaciones',
            'join'    => '',
            'where'   => 'idObservaciones = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
        ...
        if($rowData['status']){
            ...
            /******************************************/
            //Se instancia la vista
            $this->showVista(2, $this->returnRutaVista(__DIR__, 'app').'/'.$this->controllerName.'-Resumen-Observaciones-formEdit.php');
        /*******************************************************************/
        //si no hay resultados
        } else {
            //Busco errores de la consulta
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idProducto,Observacion,FechaCreacion',
            'required'  => 'idProducto,Observacion,FechaCreacion',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'productos_listado_observaciones',
            'Post'      => $_POST
    ...
    private function dataCheck($POST){
        ...
        $DataChecking = [
            ...
            'encode'                    => '',
            'ValidarEmail'              => '',
            'ValidarNumero'             => 'idProducto',
            'ValidarEntero'             => 'idProducto',
            'ValidarRut'                => '',
            'ValidarPatente'            => '',
