...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class productosListadoDocumentos extends ControllerBase {
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idDocumentos,idProducto,Nombre,Observacion,FVencimiento',
            'table'   => 'productos_listado_documentos',
            'join'    => '',
            'where'   => 'idDocumentos = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idProducto,Nombre,Observacion,FVencimiento',
            'required'  => 'idProducto,Nombre',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'productos_listado_documentos',
            'Post'      => $_POST,
