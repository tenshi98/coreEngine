...
class productosTipos extends ControllerBase {
    ...
    public function UpdateList($f3){
        ...
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_int, 'productos_tipos', 1);
        $whereInt = $r['where']; $whereParams = $r['params'];
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_string, 'productos_tipos', 2);
        $whereInt = $r['where']; $whereParams = $r['params'];
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_between, 'productos_tipos', 3);
        $whereInt = $r['where']; $whereParams = $r['params'];
