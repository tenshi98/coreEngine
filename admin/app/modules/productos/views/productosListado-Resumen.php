    ...
    <div class="card">
        <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-grid d-md-flex justify-content-md-between">
                ...
                <?php if($data['UserData']["productosListadoVerDocumentos"]==2){ ?>  <li class="nav-item flex-fill"><button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#resumen-documentos" onclick="tabDocumentosLoadList()"><i class="bi bi-file-text"></i> Documentos</button></li><?php } ?>
                    ...
                    <form id="FormEditData" name="FormEditData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
                        <div class="d-flex justify-content-center pt-4">
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-9 col-xl-8 col-xxl-6">
                                ...
                                $x1  = $data['rowData']['idTipoProducto'] ?? '';
                                $x2  = $data['rowData']['idCategoria'] ?? '';
                                $x3  = $data['rowData']['Nombre'] ?? '';
                                $x4  = $data['rowData']['Marca'] ?? '';
                                $x5  = $data['rowData']['idUniMed'] ?? '';
                                $x6  = $data['rowData']['Codigo'] ?? '';
                                $x7  = $data['rowData']['Descripcion'] ?? '';
                                $x8  = $data['rowData']['StockLimite'] ?? '';
                                $x9  = $data['rowData']['ValorIngreso'] ?? '';
                                $x10 = $data['rowData']['ValorEgreso'] ?? '';
