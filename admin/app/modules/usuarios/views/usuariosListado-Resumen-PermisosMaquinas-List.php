                        ...
                        <td>
                            <div class="col-sm-8 field">
                                <div class="form-check checkbox-success form-switch required=" required>
                                    <input                          type="hidden"   value="1" name="<?php echo 'switch_'.$perm['idMaquina']; ?>">
                                    <input class="form-check-input" type="checkbox" value="2" name="<?php echo 'switch_'.$perm['idMaquina']; ?>" onclick="activar(<?php echo $perm['idMaquina']; ?>)" <?php echo $checked; ?>>
                                </div>
                            </div>
                        </td>
                    </tr>
...
<script>
    ...
    $("#FormUpdatePermisosMaquinas").submit(function(e) {
        ...
        let Informacion = $("#FormUpdatePermisosMaquinas").serialize();
        const Options     = {
