<form id="FormNewGuia" name="FormNewGuia" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data" aria-label="Formulario de ejecucion">
    ...
    <div class="modal-body">
        ...
        $data['Fnc_FormInputs']->formSelect([ 'Placeholder' => 'Guias de Despacho',  'Name' => 'idFacturacionRel', 'Id' => 'NewGuia_idFacturacionRel', 'Value' => '','Required' => 2,'arrData' => $data['arrGuias']]);
...
<script>
    ...
    $("#FormNewGuia").submit(function(e) {
        ...
        if(validatorResult.valid===false){
            ...
            let Informacion = $("#FormNewGuia").serialize();
            const Options     = {
                UpdateDiv : [
