...
switch ($data['rowData']['idTipo']) {
    ...
    case 1:
        $From = '
        <strong class="cs-primary_color">Proveedor:</strong>
        <p class="cs-mb8">
            <strong>'.$NombreEntidad.'</strong><br>';
            if(isset($data['rowData']['EntidadesDireccion'])&&$data['rowData']['EntidadesDireccion']!=''){ $From .= $data['rowData']['EntidadesDireccion'].'<br>';}
            if(isset($data['rowData']['EntidadesComuna'])&&$data['rowData']['EntidadesComuna']!=''){       $From .= $data['rowData']['EntidadesComuna'].'<br>';}
            if(isset($data['rowData']['EntidadesCiudad'])&&$data['rowData']['EntidadesCiudad']!=''){       $From .= $data['rowData']['EntidadesCiudad'].'<br>';}
            if(isset($data['rowData']['EntidadesEmail'])&&$data['rowData']['EntidadesEmail']!=''){         $From .= 'Email: '.$data['rowData']['EntidadesEmail'].'<br>';}
            if(isset($data['rowData']['EntidadesFono1'])&&$data['rowData']['EntidadesFono1']!=''){         $From .= 'Celular: '.$data['Fnc_DataNumbers']->formatPhone($data['rowData']['EntidadesFono1']).'<br>';}
            if(isset($data['rowData']['EntidadesFono2'])&&$data['rowData']['EntidadesFono2']!=''){         $From .= 'Telefono: '.$data['Fnc_DataNumbers']->formatPhone($data['rowData']['EntidadesFono2']).'<br>';}
        $From .= '</p>';
        $To = '
        ...
        <p>
            ...
            if(isset($data['rowSistema']['Sistema_Ciudad'])&&$data['rowSistema']['Sistema_Ciudad']!=''){       $To .= $data['rowSistema']['Sistema_Ciudad'].'<br>';}
            if(isset($data['rowSistema']['Sistema_Email'])&&$data['rowSistema']['Sistema_Email']!=''){         $To .= 'Email: '.$data['rowSistema']['Sistema_Email'].'<br>';}
            if(isset($data['rowSistema']['Sistema_Fono1'])&&$data['rowSistema']['Sistema_Fono1']!=''){         $To .= 'Celular: '.$data['Fnc_DataNumbers']->formatPhone($data['rowSistema']['Sistema_Fono1']).'<br>';}
            if(isset($data['rowSistema']['Sistema_Fono2'])&&$data['rowSistema']['Sistema_Fono2']!=''){         $To .= 'Telefono: '.$data['Fnc_DataNumbers']->formatPhone($data['rowSistema']['Sistema_Fono2']).'<br>';}
        $To .= '</p>';
        break;
    /*******************************/
    //Egreso
