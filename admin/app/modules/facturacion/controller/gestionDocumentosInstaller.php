    ...
    public function listRouteModule($Type, $permisosID){
        ...
        switch ($Type) {
            ...
            case 2:
                ...
                $arrRutas[] = ['idPermisos' => $permisosID, 'idMetodo' => 1, 'RutaWeb' => 'gestionDocumentos/ventas/listado/noPrintDoc/@id',             'RutaController' => 'gestionDocumentos->noPrintDoc',             'Descripcion' => 'Pantalla para visualizar documento',             'idLevelLimit' => 1, 'Controller' => 'gestionDocumentos'];
