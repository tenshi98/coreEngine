...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class serviciosCategorias extends ControllerBase {
    ...
    public function __construct(){
        ...
        /*================== Instancias =================*/
        $this->controllerName = 'serviciosCategorias';
    ...
    public function listAll($f3){
        ...
        if(is_array($arrList)){
            ...
            $f3->data = [
                /*=========== Datos de la Pagina ===========*/
                'PageTitle'       => 'Categorias Servicios',
                'PageDescription' => 'Categorias Servicios.',
                'PageAuthor'      => ConfigAPP::SOFTWARE['SoftwareName'],
                'PageKeywords'    => ConfigAPP::SOFTWARE['SoftwareName'],
                'TableTitle'      => 'Categorias Servicios',
                /*===========  Datos del usuario ===========*/
                'UserData'      => $UserData,
    ...
    public function UpdateList($f3){
        ...
        $whereInt = $this->searchWhere($whereInt, $WhereData_int, 'servicios_categorias', 1);
        $whereInt = $this->searchWhere($whereInt, $WhereData_string, 'servicios_categorias', 2);
        $whereInt = $this->searchWhere($whereInt, $WhereData_between, 'servicios_categorias', 3);
    ...
    public function View($f3, $params){
        ...
        $query = [
            ...
            'table'   => 'servicios_categorias',
            'join'    => '',
            'where'   => 'idCategoria = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
            'having'  => '',
            'order'   => ''
        ];
