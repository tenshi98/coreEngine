...
class serviciosCategorias extends ControllerBase {
    ...
    public function UpdateList($f3){
        ...
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_int, 'servicios_categorias', 1);
        $whereInt = $r['where']; $whereParams = $r['params'];
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_string, 'servicios_categorias', 2);
        $whereInt = $r['where']; $whereParams = $r['params'];
        $r = $this->searchWhere($whereInt, $whereParams, $WhereData_between, 'servicios_categorias', 3);
        $whereInt = $r['where']; $whereParams = $r['params'];
