...
/*                                              Se define la clase                                                 */
/*******************************************************************************************************************/
class serviciosListadoDocumentos extends ControllerBase {
    ...
    public function GetID($f3, $params){
        ...
        //Se genera la query
        $query = [
            'data'    => 'idDocumentos,idServicio,Nombre,Observacion,FVencimiento',
            'table'   => 'servicios_listado_documentos',
            'join'    => '',
            'where'   => 'idDocumentos = "'.$this->Codification->encryptDecrypt('decrypt', $params['id']).'"',
            'group'   => '',
    ...
    public function Insert(){
        ...
        //Se genera la query
        $query = [
            'data'      => 'idServicio,Nombre,Observacion,FVencimiento',
            'required'  => 'idServicio,Nombre',
            'unique'    => '',
            'encode'    => '',
            'table'     => 'servicios_listado_documentos',
            'Post'      => $_POST,
