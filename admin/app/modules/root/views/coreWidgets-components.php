        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="row">
                <div class="col-sm-4 col-xl-4">
                    ...
                    $ShowPubDate    = 'true';
                    $Type           = 1;
                    $data['Fnc_WidgetsCommon']->widget_feed($Type, $Titulo, $Identificador, $URL, $MaxCount, $height, $ShowDesc, $ShowPubDate, $BASE);
                    ?>
                </div>
                <div class="col-sm-4 col-xl-4">
                    <?php
                ...
                <div class="col-sm-4 col-xl-4">
                    <?php $data['Fnc_WidgetsCommon']->widget_radio_player($BASE); ?>
                </div>
                <div class="col-sm-4 col-xl-4">
