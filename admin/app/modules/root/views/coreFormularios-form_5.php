    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="form5" name="form5" class="row g-3" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
                ...
                $data['Fnc_FormInputs']->formNumberSpinner([        'FormAling' => 5,'FormCol' => 12,'Placeholder' => 'number_spinner',            'Name' => 'number_spinner','Id' => 'IDInput_5_9','Required' => 2,'Min' => 1,'Max' => 20,'Step' => 1,'Ndecimal' => 0]);
