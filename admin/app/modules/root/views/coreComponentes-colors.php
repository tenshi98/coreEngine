    ...
    <div class="card">
        <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-grid d-md-flex justify-content-md-between">
                <li class="nav-item flex-fill"><button class="nav-link w-100 active" data-bs-toggle="tab" data-bs-target="#fuentes"><i class="bi bi-card-list"></i> Fuentes</button></li>
                <li class="nav-item flex-fill"><button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#bootstrap"><i class="bi bi-card-list"></i> Bootstrap</button></li>
                <li class="nav-item flex-fill"><button class="nav-link w-100" data-bs-toggle="tab" data-bs-target="#mycolors"><i class="bi bi-card-list"></i> My Colors</button></li>
            </ul>
...
<style>
 	.list-unstyled li { height: 50px;line-height: 50px;}
</style>