        ...
        <div class="modal-content">
            <form id="FormNewData" name="FormNewData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    $data['Fnc_FormInputs']->formInput(['FormType' => 1, 'Placeholder' => 'Icono',               'Name' => 'Icon',         'Value' => '', 'Required' => 2]);
                    $data['Fnc_FormInputs']->formSelect([                'Placeholder' => 'Color Icono',         'Name' => 'IdIconColor',  'Value' => '', 'Required' => 2,'arrData' => $data['arrColores']]);
                    $data['Fnc_FormInputs']->formTextarea([              'Placeholder' => 'Descripcion',         'Name' => 'Descripcion',  'Value' => '', 'Required' => 1]);
                    $data['Fnc_FormInputs']->formInput(['FormType' => 1, 'Placeholder' => 'Carpeta Contenedora', 'Name' => 'Carpeta',      'Value' => '', 'Required' => 2]);
