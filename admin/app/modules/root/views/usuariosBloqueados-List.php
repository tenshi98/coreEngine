            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="X_datatable">
                        <?php require_once('usuariosBloqueados-UpdateList.php'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    function TDdelBTN_1(ID, Dato) {
        Swal.fire({
            ...
            if (result2.isConfirmed) {
                ...
                //Ejecuto
                let Metodo      = 'DELETE';
                let Direccion   = '<?php echo $BASE.'/Core/administracion/bloqueo-usuarios'; ?>';
                let Informacion = {"Email": ID};
                const Options     = {
                    UpdateDiv : [
                        {Div:'#X_datatable', fromData:'<?php echo $BASE.'/Core/administracion/bloqueo-usuarios/updateList'; ?>', refreshTbl:'true'}
                    ],
