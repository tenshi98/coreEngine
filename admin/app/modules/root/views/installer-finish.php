                    ...
                    <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-end">
                                <a href="<?php echo $BASE.'/install/summary'?>" class="btn btn-danger"><i class="bi bi-arrow-left-circle"></i> Retroceder</a>
                                <a href="<?php echo $BASE.'/install/welcome'?>" class="btn btn-primary"> Siguiente <i class="bi bi-arrow-right-circle"></i></a>
                            </div>
