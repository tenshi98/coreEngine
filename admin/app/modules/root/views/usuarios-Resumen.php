                    ...
                    <form id="FormEditData" name="FormEditData" autocomplete="off" method="POST" action="" role="form" novalidate enctype="multipart/form-data">
                        <div class="d-flex justify-content-center pt-4">
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-9 col-xl-8 col-xxl-6">
                                ...
                                $x9  = $data['rowData']['idEstado'] ?? '';
                                $x10 = $data['rowData']['Social_X'] ?? '';
                                $x11 = $data['rowData']['Social_Facebook'] ?? '';
                                $x12 = $data['rowData']['Social_Instagram'] ?? '';
                                $x13 = $data['rowData']['Social_Linkedin'] ?? '';
                                ...
                                $data['Fnc_FormInputs']->formSelect([                'Placeholder' => 'Estado',           'Name' => 'idEstado',      'Id' => 'Edit_idEstado',       'Value' => $x9, 'Required' => 2,'arrData' => $data['arrEstado']]);

                                $data['Fnc_FormInputs']->formTittle(['Tipo' => 4,'Texto' => 'Social']);
                                $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'X (Twitter)', 'Name' => 'Social_X',          'Id' => 'Edit_Social_X',         'Value' => $x10, 'Required' => 1, 'Icon' => 'bi bi-x']);
                                $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'Facebook',    'Name' => 'Social_Facebook',   'Id' => 'Edit_Social_Facebook',  'Value' => $x11, 'Required' => 1, 'Icon' => 'bi bi-facebook']);
                                $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'Instagram',   'Name' => 'Social_Instagram',  'Id' => 'Edit_Social_Instagram', 'Value' => $x12, 'Required' => 1, 'Icon' => 'bi bi-instagram']);
                                $data['Fnc_FormInputs']->formInput(['FormType' => 1,  'Placeholder' => 'Linkedin',    'Name' => 'Social_Linkedin',   'Id' => 'Edit_Social_Linkedin',  'Value' => $x13, 'Required' => 1, 'Icon' => 'bi bi-linkedin']);
