    ...
    <ul class="dropdown-menu dropdown-menu-large dropdown-menu-large-arrow row">
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul>
                ...
                <li><a href="<?php echo $BASE.'/Core/permisos/categorias/listAll'; ?>">   <i class="bi bi-card-list text-color-blue"></i> Permisos - Categorias</a></li>
                <li><a href="<?php echo $BASE.'/Core/permisos/listado/listAll'; ?>">      <i class="bi bi-card-list text-color-blue"></i> Permisos - Listado</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo $BASE.'/Core/administracion/usuarios/listAll'; ?>">           <i class="bi bi-card-list text-color-blue"></i> Administrar Administradores</a></li>
                <li><a href="<?php echo $BASE.'/Core/administracion/bloqueo-usuarios/listAll'; ?>">   <i class="bi bi-card-list text-color-blue"></i> Usuarios Bloqueados</a></li>
                <li class="divider"></li>
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul>
                ...
                <li><a href="<?php echo $BASE.'/Core/pruebas/crudNormal/listAll'; ?>">    <i class="bi bi-gear text-color-yellow-light"></i> Crud Normal</a></li>
                <li><a href="<?php echo $BASE.'/Core/pruebas/crudResumen/listAll'; ?>">   <i class="bi bi-gear text-color-yellow-light"></i> Crud Resumen</a></li>
                <li><a href="<?php echo $BASE.'/Core/pruebas/crudInforme/listAll'; ?>">   <i class="bi bi-gear text-color-yellow-light"></i> Informes</a></li>
                <li class="divider"></li>
            </ul>
        </li>
    ...
    <ul class="dropdown-menu dropdown-menu-large dropdown-menu-large-arrow row">
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul>
                ...
                <li><a href="<?php echo $BASE.'/Core/Componentes/acordeon'; ?>">     <i class="bi bi-puzzle text-color-blue"></i> Acordeon</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/alertas'; ?>">      <i class="bi bi-puzzle text-color-blue"></i> Alertas</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/badges'; ?>">       <i class="bi bi-puzzle text-color-blue"></i> Badges</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/breadcrumbs'; ?>">  <i class="bi bi-puzzle text-color-blue"></i> Breadcrumbs</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/buttons'; ?>">      <i class="bi bi-puzzle text-color-blue"></i> Botones</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/cards'; ?>">        <i class="bi bi-puzzle text-color-blue"></i> Cards</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/carousel'; ?>">     <i class="bi bi-puzzle text-color-blue"></i> Carousel</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/colors'; ?>">       <i class="bi bi-puzzle text-color-blue"></i> Colores</a></li>
                <li><a href="<?php echo $BASE.'/Core/Componentes/icons'; ?>">        <i class="bi bi-puzzle text-color-blue"></i> Iconos</a></li>
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul>
                ...
                <li><a href="<?php echo $BASE.'/Core/Formularios/formularios'; ?>">  <i class="bi bi-card-list text-color-green-dark"></i> Form Inputs</a></li>
                <li class="divider"></li>
            </ul>
            <ul>
        ...
        <li class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            <ul>
                ...
                <li><a href="<?php echo $BASE.'/Core/Graficos/chartjs'; ?>">        <i class="bi bi-bar-chart-line text-color-amber-text"></i> Chartjs</a></li>
                <li><a href="<?php echo $BASE.'/Core/Graficos/echarts'; ?>">        <i class="bi bi-bar-chart-line text-color-amber-text"></i> Echarts</a></li>
                <li class="divider"></li>
            </ul>
            <ul>
